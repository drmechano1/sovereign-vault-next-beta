  ...
  const tiers = [
    {
      ...
      price: "$19",
      cadence: "per month",
      tagline: "Secure start for growing stacks.",
      featured: false,
      highlight: "Best for individuals testing the waters.",
      features: [
        "1 @name with smart-contract vault protection",
        "1 NFC card with EAL6+ secure element",
        "SafeSend delays on outbound transfers",
        "AI risk scores on counterparties",
    ...
    },
    {
      ...
      price: "$49",
      cadence: "per month",
      tagline: "Full command center for serious holders.",
      featured: true,
      highlight: "Recommended for active traders and high net-worth users.",
      features: [
        "Up to 5 @names with vault-level protection",
        "2 NFC cards + mobile app with biometric access",
        "Advanced SafeSend policies & guardian approvals",
        "AI risk engine with real-time alerts",
    ...
    },
    {
      ...
      price: "Talk to us",
      cadence: "",
      tagline: "Policies, reporting, and controls for teams.",
      featured: false,
      highlight: "For funds, family offices, and enterprises.",
      features: [
        "Custom @name and vault policy design",
        "Multi-user access controls and approvals",
        "Compliance-aware reporting and export",
        "Dedicated account manager",
        "Bespoke integrations under NDA",
      ],
    },
  ];
